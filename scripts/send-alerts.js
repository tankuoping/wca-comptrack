...
function buildEmail(sub, newComps, regOpenComps, regClosingComps) {
      ...
      const html = '<!DOCTYPE html><html><body style="font-family:Arial,sans-serif;margin:0;padding:0;background:#f4f4f4;"><div style="max-width:520px;margin:24px auto;background:#fff;border-radius:8px;overflow:hidden;"><div style="background:#003f88;padding:20px 24px;color:#fff;"><h1 style="margin:0;font-size:18px;">' + total + ' competition alert' + (total>1?'s':'') + '</h1><p style="margin:4px 0 0;font-size:12px;opacity:0.7;">Matching: ' + sub.countries.join(', ') + evLabel + '</p></div><div style="padding:16px 24px;">' + body + '<div style="text-align:center;padding:16px 0 8px;"><a href="' + APP_URL + '" style="display:inline-block;background:#00695c;color:#fff;font-size:13px;font-weight:700;padding:10px 24px;border-radius:6px;text-decoration:none;">View on WCA-CompTrack</a></div></div><div style="padding:14px 24px 20px;border-top:1px solid #eee;text-align:center;font-size:11px;color:#aaa;">You are receiving this because you subscribed to WCA CompAlert.<br><a href="' + APP_URL + '/subscribe" style="color:#003f88;">Manage preferences</a> - <a href="' + unsubUrl + '" style="color:#003f88;">Unsubscribe</a></div></div></body></html>'
      return { subject, html }
}
